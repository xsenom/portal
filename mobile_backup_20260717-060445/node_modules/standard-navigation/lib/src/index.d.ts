...
export declare function createStandardNavigator<NavigatorOptions extends {}, NavigatorEventMap extends NavigatorEventMapBase, NavigatorProps extends object = {}>(NavigatorContent: React.ComponentType<NavigatorArgs<NavigatorOptions, NavigatorEventMap> & Omit<NavigatorProps, keyof NavigatorArgs<NavigatorOptions, NavigatorEventMap>>>): {
    readonly type: "standard";
    readonly version: 1;
    readonly NavigatorContent: React.ComponentType<NavigatorArgs<NavigatorOptions, NavigatorEventMap> & Omit<NavigatorProps, keyof NavigatorArgs<NavigatorOptions, NavigatorEventMap>>>;
};
export {};
