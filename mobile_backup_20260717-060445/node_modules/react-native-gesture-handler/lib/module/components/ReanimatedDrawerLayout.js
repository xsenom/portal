...
import { InterceptingGestureDetector, VirtualGestureDetector } from '../v3/detectors';
...
const DrawerLayout = function DrawerLayout(props) {
  ...
  const panGesture = usePanGesture({
    ...
    enabled: drawerState !== DrawerState.SETTLING && (drawerOpened ? drawerLockMode !== DrawerLockMode.LOCKED_OPEN : drawerLockMode !== DrawerLockMode.LOCKED_CLOSED),
    onActivate: () => {
      'worklet';
  ...
  return /*#__PURE__*/_jsx(InterceptingGestureDetector, {
    gesture: panGesture,
    ...
    children: /*#__PURE__*/_jsxs(Animated.View, {
      ...
      children: [/*#__PURE__*/_jsx(VirtualGestureDetector, {
