...
import { I18nManager, Keyboard, Platform, StatusBar, StyleSheet, useWindowDimensions, View } from 'react-native';
...
export function Drawer({
  ...
  React.useLayoutEffect(() => {
    if (hasDrawerWidth !== previousHasDrawerWidthRef.current && isHidden.value) {
  ...
  }, [direction, drawerPosition, drawerType, drawerWidth, isHidden, layout.width, translateX]);
