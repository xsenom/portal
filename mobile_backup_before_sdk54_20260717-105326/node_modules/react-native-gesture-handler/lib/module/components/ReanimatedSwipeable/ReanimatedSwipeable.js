...
import Animated, { interpolate, measure, ReduceMotion, runOnJS, runOnUI, useAnimatedRef, useAnimatedStyle, useSharedValue, withSpring } from 'react-native-reanimated';
...
const Swipeable = props => {
  ...
  if (__DEV__) {
    ...
    useEffect(() => {
      if (!Reanimated?.isSharedValue(dragOffsetFromRight)) {
        return;
      }
