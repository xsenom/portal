...
var PointerState = /*#__PURE__*/function (PointerState) {
  ...
  return PointerState;
}(PointerState || {}); // Clamp user-supplied durations to finite, non-negative milliseconds.
...
export const Touchable = props => {
  ...
  const startLongPressTimer = useCallback(() => {
    ...
    if (onLongPress && !longPressTimeout.current) {
      longPressTimeout.current = setTimeout(wrappedLongPress, resolvedDelayLongPress);
    }
