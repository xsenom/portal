...
export type PanGestureExternalProperties = CommonPanGestureProperties & OffsetProps;
export type PanGestureNativeProperties = Omit<CommonPanGestureProperties, 'minDistance' | 'averageTouches'> & {
    minDist?: number;
    avgTouches?: boolean;
